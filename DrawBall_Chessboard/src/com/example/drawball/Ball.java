...
import com.example.drawball.R;

import android.content.Context;
import android.opengl.GLES30;

public class Ball {
	private static final String TAG = "BallChess";
	...
	private static final float RADIAN = 0.5f;
	...
	private static final String U_RAD = "uRad";	
	...
	public Ball(Context context) {
		...
		uRad = GLES30.glGetUniformLocation(program, U_RAD);
		Logit.d(TAG, "uRadLocation: " + uRad);
		GLES30.glUniform1f(uRad, RADIAN);  // 设置半径
		
		nCount = GLES30.glGetUniformLocation(program, N_COUNT);
		GLES30.glUniform1f(nCount, 10); //设置棋盘纹理划分个数
