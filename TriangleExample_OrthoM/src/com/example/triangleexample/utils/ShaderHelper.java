/**
 * http://blog.csdn.net/cassiepython/article/details/51540194
 */

package com.example.triangleexample.utils;
...
public class ShaderHelper {  
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId) {  
		...
		Logit.v(TAG, "Results of linking program:\n"
